...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_hoist_non_react_statics__ = __webpack_require__(12);
...
var ScrollingList = function (_Component) {
    _inherits(ScrollingList, _Component);

    function ScrollingList(props) {
        _classCallCheck(this, ScrollingList);

        var _this = _possibleConstructorReturn(this, (ScrollingList.__proto__ || Object.getPrototypeOf(ScrollingList)).call(this, props));

        _this.id = _shortid2.default.generate();
        return _this;
    }

    _createClass(ScrollingList, [{
        ...
        key: '_setupScroll',
        value: function _setupScroll(update) {
            var ps = new _perfectScrollbar2.default(document.getElementById(this.id), {
                wheelSpeed: .5
            });
            if (update) ps.update();
        }
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                Wrapper,
                { id: this.id, maxHeight: maxHeight || '200px', maxWidth: maxWidth || '100%', color: color || '#ccc', style: style, className: className },
                children
            );
        }
    }]);
...
var Wrapper = _styledComponents2.default.div(_templateObject, function (props) {
    ...
    return 'rgba(' + hex2rgb(props.color) + ',.15)';
}, function (props) {
    return props.color;
}, function (props) {
    return 'rgba(' + hex2rgb(props.color) + ',.1)';
}, function (props) {
    return props.color;
});
